...
public class IndexedPageReadTest extends SimpleDbTestBase {
    ...
    static {
        ...
        // Convert it to a IndexedFile and read in the bytes
        try {
            File temp = File.createTempFile("table", ".dat");
            temp.deleteOnExit();
            IndexedFileEncoder.convert(table, temp, BufferPool.PAGE_SIZE, 2);
     ...
     * Unit test for IndexedPage.getNumEmptySlots()
    ...
    public static junit.framework.Test suite() {
        return new JUnit4TestAdapter(IndexedPageReadTest.class);
    }
}
